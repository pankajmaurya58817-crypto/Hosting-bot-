...
# --- Configuration ---
TOKEN = '8795859943:AAHE3HNDMFLf1up8fmIAg7hOlaNxroU48p4' # Replace with your actual token
OWNER_ID = 8399655310 # Replace with your Owner ID
ADMIN_ID = 7721021754 # Replace with your Admin ID (can be same as Owner)
YOUR_USERNAME = '@Iw_selfowner' # Replace with your Telegram username (without the @)
UPDATE_CHANNEL = 'https://t.me/SELFXABOUT' # Replace with your update channel link
...
logger = logging.getLogger(__name__)   # <--- FIXED: changed Blogger to logger
